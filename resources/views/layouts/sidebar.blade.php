<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <div class="app-brand demo ">
        <a href="{{ route('dashboard') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Samsung</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="{{ route('phone') }}" class="menu-link">
                        <div data-i18n="Without menu">{{ __('menu.phone') }}</div>
                    </a>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="{{ route('washing') }}" class="menu-link">
                        <div data-i18n="Without menu">{{ __('menu.washing') }}</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('screen') }}" class="menu-link">
                        <div data-i18n="Without menu">{{ __('menu.screen') }}</div>
                    </a>
                </li>
                <li class="menu-item">
